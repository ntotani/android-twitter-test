BattleScene = enchant.Class.create(enchant.Scene, {
  initialize: function() {
    ...
    var actionList = new ListBox(
        ...
        function(e) {
          ...
          if(e == 4) {
            ...
            var list = (e == ActType.Talk || e == ActType.Lie) ? talkList : girlList;
    ...
    var dummyList = new ListBox([], 200, 120, function(){});
    dummyList.x = 110;
    dummyList.y = 190;
...
ListBox = enchant.Class.create(enchant.Group, {
  initialize: function(list, wid, hei, onSelected) {
    enchant.Group.call(this);
